...
if (isset($_POST['sellerLogin'])) {
    ...
    $sql = "SELECT * FROM `sellers` WHERE  sellerID='$sellerID' AND password='$password'";
    ...
    if ($rows == 1) {
        ...
        echo ("<script>window.location = 'http://localhost/Projects/fyproject/seller/sellerIndex.php';</script>");
    } else {
...
<body>
    ...
    <div class="container">
        <div class="title">Seller Login</div><br>
        <div class="content">
            <form method="POST" action="" name="login">
                ...
                <div class="button">
                    <input type="submit" name="sellerLogin" value="Login" /><br><br>
                    <a href="sellerSignup.php">Don't have an account? Register Here!</a>
                </div>
            </form><br>
            <a style="color: purple; text-decoration:underline;" onclick=openForm()>Forgot Password?</a><br>
            <form action="retrieve_password2.php" method="post" id="forgotPass" style="display: none;">
